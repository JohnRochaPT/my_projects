...
def strt_w2_lttrs(plate: str) -> bool:
    ''' Function accepts a string and inspects it to make sure that the first two characters
        are letters.

        Returns True if the first two characters are letters and not numbers or False if they
        are not.
    '''
